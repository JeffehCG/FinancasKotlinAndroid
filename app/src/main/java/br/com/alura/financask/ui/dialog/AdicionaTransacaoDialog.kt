...
class AdicionaTransacaoDialog (private val viewGroup: ViewGroup,
    ...
    //Campos da View
    private val campoValor = viewCriadaAddReceita.form_transacao_valor
    private val campoData = viewCriadaAddReceita.form_transacao_data
    private val campoCategoria = viewCriadaAddReceita.form_transacao_categoria
    ...
    private fun configuraFormulario(tipo: Tipo, transacaoDelegate: TrasacaoDelegate) {
        ...
        AlertDialog.Builder(context)//Colocando alert quando é clicado no botão
                ...
                .setPositiveButton("Adicionar", //Adicionando botão inserir transação
                        { dialogInterface, i ->
    ...
    private fun getTituloPeloTipo(tipo: Tipo): Int {
    ...
    private fun getCategoriasPeloTipo(tipo: Tipo): Int {
        if (tipo == Tipo.RECEITA) {
    ...
    private fun configuraCampoData() {
        ...
        campoData.setOnClickListener {
            ...
            DatePickerDialog(context,
                    DatePickerDialog.OnDateSetListener { view, ano, mes, dia -> // _ = quando o campo não esta sendo usado (view)
